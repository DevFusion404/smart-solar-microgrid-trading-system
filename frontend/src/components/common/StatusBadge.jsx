...
const statusStyles = {
  ...
  Available: 'bg-blue-50 text-blue-700 dark:bg-blue-400/10 dark:text-blue-300',
  Booked: 'bg-violet-50 text-violet-700 dark:bg-violet-400/10 dark:text-violet-300',
